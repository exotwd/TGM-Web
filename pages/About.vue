<template>
    <div>
        <header class="relative w-full h-fit">
            <div class="w-full h-full bg-white">
                <div class="pt-2 flex items-center">
                    <span class="w-full border-t border-solid border-black border-"></span>
                    <span class="mx-8 min-w-fit">MASARYKOVO GYMNÁZIUM VSETÍN</span>
                ...
                <div class="flex justify-center">
                    ...
                    <div class="border-r border-solid border-black"></div>
                    <div class="w-1/6 text-center my-auto text-xs md:text-md xl:text-lg font-pt-serif">
                        {{ quote.content }}
                    </div>
                    <div class="border-r border-solid border-black"></div>
                    ...
                    <div
                        class="flex w-1/2 text-center text-[64px] md:text-[112px] my-auto mx-8 align-middle font-extrabold justify-center">
                        <a href="/">
                            <div class="my-auto ">TGM</div>
                        </a>
                        <svg class="transition ease-in-out delay-100 fill-black hover:scale-110" width="98" height="130"
                            viewBox="0 0 160 209" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <a href="/">
                                <path
                ...
                <!--the navmenu-->
                <div
                    class="flex items-center w-full border-y border-solid border-black border- mb-8 text-sm md:text-lg font-pt-serif">
                    <span
                        class="ml-2 sm:ml-8 md:ml-24 h-full w-1/4 border-x border-solid border-black border- text-center py-2">NĚCO
                        NAVÍC</span>
                    <span class="w-1/4 h-full border-r border-solid border-black border- text-center py-2">ANKETY</span>
                    <span
                        class="w-1/4 h-full border-r border-solid border-black text-center py-2 transition ease-in-out delay-100 duration-300 hover:text-white hover:bg-[#002f76]">STUDENTSKÝ
                        MĚSÍČNÍK MGV</span>
                    <span class="w-1/4 h-full border-r border-solid border-black border- text-center py-2">ROZHOVORY</span>
                    <span
                        class="mr-2 sm:mr-8 md:mr-24 h-full mx-auto w-1/4 border-r border-solid border-black border- py-2 text-center">O
                        NÁS</span>
                </div>
            </div>
        </header>
        <div class="self-stretch bg-white flex flex-col items-center justify-center py-10 xl:px-88 mx-auto w-2/3">
            <div class="self-stretch relative tracking-[0.15em] uppercase text-[64px] text-center font-road-rage">
                Proč Jsme tady.
            </div>
            <div class="self-stretch relative text-[16px] tracking-[0.15em] font-lora text-center">
                <p class="m-0">
                    Zakladatelkou TGM je Eliška Píchalová. Myšlenka založit studentské
                    noviny se zrodila v její hlavě již v roce Od té doby mnoho vody v
                    Bečvě uplynulo a Redakce TGM již pravidelně vydává tiskopis pro
                    studenty Masarykova gymnázia ve Vsetíně.
                </p>
                <p class="m-0">
                    Naši existenci popisují tři tagy, které vyjadřují vzhled, motivaci a
                    ideu k vytváření našeho tiskopisu.
                </p>
            </div>
        </div>

        <div>
            <div class="w-full text-white bg-black lg:flex font-montserrat items-center justify-center text-center">
                <div class="w-full lg:w-2/6 text-9xl text-center pt-8 lg:pt-0">
                    #STUDENTISTUDENTŮM
                </div>
                <div
                    class="mt-8 lg:mt-0 lg:border-l-[2px] lg:border-t-[0px] border-t-[2px] border-solid border-white w-full lg:w-4/6 text-[24px] lg:text-[32px] py-8 md:py-16 lg:py-32 mx-auto">
                    <p class="m-0">TISKOPIS PÍŠOU STUDENTI PRO STUDENTY.</p>
                    <p class="m-0">JE TO MÉDIUM, KDE SE MŮŽETE VYJÁDŘIT.</p>
                </div>
            </div>
            <div class="w-full text-black bg-[#DEE2E6] lg:flex font-montserrat items-center justify-center text-center">
                <div id="mobile" class="w-full lg:w-2/6 text-9xl text-center pt-8 lg:pt-0 lg:hidden">
                    #STUDENTISTUDENTŮM
                </div>
                <div
                    class="mt-8 lg:mt-0 lg:border-r-[2px] lg:border-t-[0px] border-t-[2px] border-solid border-darkslategray w-full lg:w-4/6 text-[24px] lg:text-[32px] py-8 md:py-16 lg:py-32 mx-auto ">
                    <p class="m-0">TISKOPIS PÍŠOU STUDENTI PRO STUDENTY.</p>
                    <p class="m-0">JE TO MÉDIUM, KDE SE MŮŽETE VYJÁDŘIT.</p>
                </div>
                <div class="w-full lg:w-2/6 text-9xl text-center pt-8 lg:pt-0 hidden lg:block">
                    #STUDENTISTUDENTŮM
                </div>

            </div>
            <div class="w-full text-white bg-darkslategray lg:flex font-montserrat items-center justify-center text-center">
                <div class="w-full lg:w-2/6 text-9xl text-center pt-8 lg:pt-0">
                    #STUDENTISTUDENTŮM
                </div>
                <div
        ...
        <div class="w-full text-black bg-[#DEE2E6] font-pt-serif mt-48 py-32 lg:flex">
            <div class="justify-left ml-[10%] md:ml-[20%] md:w-[60%]">
                <div class="text-[64px] font-purple-purse">Staň se jedním z nás.</div>
                <div class="">
                    Chceš se stát světoznámým žurnalistou? Máš myšlenky,které bys rád(a)
                    sdílel(a) se světem? Trápí tě něco ve škole a chceš,aby o tom věděli i
                    ostatní? Pokud máš ambice stát v řadách TGM, neváhej a vyplň dotazník!
                </div>
            </div>
            <div class="w-[50%] relative mt-8 md:mt-0">
                <a href="#"
                    class="bg-white px-10 py-4 text-black hover:underline font-medium text-lg absolute left-1/4 top-1/2">KLIKNI
                    ZDE
